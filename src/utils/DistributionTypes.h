...
namespace Utils
{
	...
	//LM added a type for the request generator
	enum class Request_Generator_Type { BANDWIDTH, QUEUE_DEPTH, BATCH_TRANSACTION};//Time_INTERVAL: general requests based on the arrival rate definitions, DEMAND_BASED: just generate a request, every time that there is a demand
}
