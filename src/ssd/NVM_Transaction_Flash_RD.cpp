...
namespace SSD_Components
{
	NVM_Transaction_Flash_RD::NVM_Transaction_Flash_RD(Transaction_Source_Type source, stream_id_type stream_id,
		...
		NVM::memory_content_type content, NVM_Transaction_Flash_WR* related_write, page_status_type read_sectors_bitmap, data_timestamp_type data_timestamp, bool read_hot) :
	...
	{
		if(read_hot)
			this->Type = Transaction_Type::READ_HOT;
	...
	NVM_Transaction_Flash_RD::NVM_Transaction_Flash_RD(Transaction_Source_Type source, stream_id_type stream_id,
		...
		NVM::memory_content_type content, page_status_type read_sectors_bitmap, data_timestamp_type data_timestamp, bool read_hot) :
