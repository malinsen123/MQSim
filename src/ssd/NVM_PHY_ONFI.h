...
{
	enum class ChipStatus { IDLE, CMD_IN, CMD_DATA_IN, DATA_OUT, READING, CMD_IN_AND_DATA_OUT, READING_AND_DATA_OUT, READING_AND_WAIT_DATA_OUT, WRITING, ERASING, WAIT_FOR_DATA_OUT, WAIT_FOR_COPYBACK_CMD };
