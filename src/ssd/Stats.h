...
namespace SSD_Components
{
	...
	public:
		...
		static unsigned long IssuedReadCMD, IssuedCopybackReadCMD, IssuedInterleaveReadCMD, IssuedMultiplaneReadCMD, IssuedMultiplaneCopybackReadCMD, IssuedMultiplaneReadhotCMD; //LM
